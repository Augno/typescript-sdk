...
export class Groups extends APIResource {
   ...
   * ```
   */
  create(body: GroupCreateParams, options?: RequestOptions): APIPromise<ConversationsAPI.MessagingGroup> {
   ...
   * ```
   */
  retrieve(id: string, options?: RequestOptions): APIPromise<ConversationsAPI.MessagingGroup> {
  ...
  ): APIPromise<ConversationsAPI.MessagingGroup> {
...
export interface ListMessagingGroup {
   ...
   */
  data: Array<ConversationsAPI.MessagingGroup>;
