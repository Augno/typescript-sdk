...
export class ProductLines extends APIResource {
   ...
   * ```
   */
  create(params: ProductLineCreateParams, options?: RequestOptions): APIPromise<ProductsAPI.ProductLine> {
  ...
  ): APIPromise<ProductsAPI.ProductLine> {
...
export interface ListProductLine {
   ...
   */
  data: Array<ProductsAPI.ProductLine>;
