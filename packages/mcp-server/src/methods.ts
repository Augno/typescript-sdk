...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.operations.inventoryChangeLogs.list',
    fullyQualifiedName: 'operations.inventoryChangeLogs.list',
    httpMethod: 'get',
    httpPath: '/v1/operations/inventory-change-logs',
  },
  {
    clientCallName: 'client.operations.inventoryChangeLogs.retrieve',
    fullyQualifiedName: 'operations.inventoryChangeLogs.retrieve',
    httpMethod: 'get',
    httpPath: '/v1/operations/inventory-change-logs/{id}',
  },
  {
  ...
  {
    clientCallName: 'client.operations.picks.list',
    fullyQualifiedName: 'operations.picks.list',
    httpMethod: 'get',
    httpPath: '/v1/operations/picks',
  },
  {
    clientCallName: 'client.operations.picks.retrieve',
    fullyQualifiedName: 'operations.picks.retrieve',
    httpMethod: 'get',
    httpPath: '/v1/operations/picks/{id}',
  },
  {
    clientCallName: 'client.operations.picks.actions.pick',
    fullyQualifiedName: 'operations.picks.actions.pick',
    httpMethod: 'put',
    httpPath: '/v1/operations/picks/{id}/actions/pick',
  },
  {
    clientCallName: 'client.operations.picks.actions.void',
    fullyQualifiedName: 'operations.picks.actions.void',
    httpMethod: 'put',
    httpPath: '/v1/operations/picks/{id}/actions/void',
  },
  {
    clientCallName: 'client.operations.picks.actions.pack',
    fullyQualifiedName: 'operations.picks.actions.pack',
    httpMethod: 'post',
    httpPath: '/v1/operations/picks/{id}/actions/pack',
  },
  {
    clientCallName: 'client.operations.picks.lines.update',
    fullyQualifiedName: 'operations.picks.lines.update',
    httpMethod: 'patch',
    httpPath: '/v1/operations/picks/{pick_id}/lines/{id}',
  },
  {
    clientCallName: 'client.operations.picks.lines.actions.pick',
    fullyQualifiedName: 'operations.picks.lines.actions.pick',
    httpMethod: 'put',
    httpPath: '/v1/operations/picks/{pick_id}/lines/{id}/actions/pick',
  },
  {
    clientCallName: 'client.operations.picks.lines.actions.void',
    fullyQualifiedName: 'operations.picks.lines.actions.void',
    httpMethod: 'put',
    httpPath: '/v1/operations/picks/{pick_id}/lines/{id}/actions/void',
  },
  {
